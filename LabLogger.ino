/* This is the code for the Arduino connected to the filtration experiment system in Lab 25. 
It creates a data logging unit for gathering information from a pressure sensor and a scale. 
